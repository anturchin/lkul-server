const q = 'qReportFactGasPrice';
const rpn = require('request-promise-native');
const boom = require('boom');
const moment = require('moment');
const { log } = require('./requests.log');

module.exports = async (cons_uid, contr_uid, st_date1 = '2019-01-01T00:00:00', end_date1 = '2019-12-31T00:00:00', st_date2 = '2019-01-01T00:00:00', end_date2 = '2019-12-31T00:00:00', data_group = 0, sbis_url, cons_point_uid) => {
    const options = {
        method: 'POST',
        uri: (sbis_url) + '/' + q,
        json: true,
